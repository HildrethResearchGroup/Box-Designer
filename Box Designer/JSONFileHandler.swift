...
//       var jsonText = Data()
//        do {
//            jsonText =  try Data(contentsOf: targetURL) //String(contentsOf: targetURL, encoding: String.Encoding.utf8)
//        } catch {
//            print("Could not read model to be opened.")
//        }
//        let oldModel = decoder.decode(BoxModel.Decodable, from: jsonText)
